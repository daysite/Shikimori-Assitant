...
✦ 𝙿𝚊𝚛𝚊: *${name}*
✦ 𝙼𝚘𝚖𝚎𝚗𝚝𝚘𝚜 𝚍𝚎 𝚎𝚜𝚝𝚒𝚕𝚘, 𝚒𝚗𝚜𝚙𝚒𝚛𝚊𝚌𝚒𝚘́𝚗 𝚢 𝚎𝚗𝚎𝚛𝚐𝚒́𝚊 ♡

✿ 𝙳𝚊 𝚌𝚕𝚒𝚌 𝚊𝚋𝚊𝚓𝚘 𝚙𝚊𝚛𝚊 𝚘𝚝𝚛𝚘 𝚌𝚘𝚜𝚙𝚕𝚊𝚢:`,
    footer: 'Waguri Ai — 𝒔𝒆𝒏𝒔𝒆 𝒐𝒇 𝒆𝒍𝒆𝒈𝒂𝒏𝒄𝒆',
    buttons: [
      { buttonId: `${usedPrefix}cosplay`, buttonText: { displayText: '⛧ Otro Cosplay ⛧' }, type: 1 }
//      { buttonId: `${usedPrefix}anime`, buttonText: { displayText: '❀ Más Anime' }, type: 1 }
    ],
    headerType: 4
  }, { quoted: m })
}
